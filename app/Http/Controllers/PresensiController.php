...
class PresensiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($radius > $lok_kantor->radius) {
            echo 'error|Anda Berada Diluar Radius Absen'.$radius.'meter dari kantor|radius';
        } else {
            if ($cek > 0) {
                $data_pulang = [
                    'jam_out' => $jam,
                ...
                if ($update) {
                    echo 'success|Selamat Beristirahat|in';
                ...
                if ($simpan) {
                    echo 'success|Selamat Berkerja|in';
                    Storage::put($file, $image_base64);
                } else {
                    echo 'error|Gagal Absen|out';
                }
...
public function distance($lat1, $lon1, $lat2, $lon2)
{
    ...
    public function getpresensi(Request $request)
    {
        ...
        ->join('divisi', 'karyawans.kode_div', '=', 'divisi.kode_div')
    ...
    public function izinsakit(Request $request)
    {
        ...
        if (!empty($request->dari) && !empty($query->sampai)) {
