                    ...
                    <?php if(Session::get('success')): ?>
                        ...
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="<?php echo e($lok_kantor->lokasi_kantor); ?>" id="lokasi_kantor" class="form-control" placeholder="Lokasi Kantor" name="lokasi_kantor">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="<?php echo e($lok_kantor->radius); ?>" id="radius" class="form-control" placeholder="Radius Absen" name="radius">
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<?php echo $__env->make('layouts.admin.tabler', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Rezky\OneDrive\Documents\project\september\laravel absen\absen\resources\views/konfigurasi/lokasikantor.blade.php ENDPATH**/ ?>