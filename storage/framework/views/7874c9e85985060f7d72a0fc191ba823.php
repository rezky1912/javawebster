  ...
  <div class="row">
    <div class="col-12">
      <div class="input-icon mb-3">
        ...
        <input type="text" readonly value="<?php echo e($nik); ?>" id="nik" class="form-control" placeholder="NIK" name="nik">
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-12">
      <select name="kode_div" id="kode_div" class="form-select mt-2">
        ...
        <option <?php echo e(Request('kode_div')==$d->kode_div ? 'selected' : ''); ?> value="<?php echo e($d->kode_div); ?>"><?php echo e($d->nama_div); ?></option>
...
<?php /**PATH C:\Users\Rezky\OneDrive\Documents\project\september\laravel absen\absen\resources\views/karyawan/edit.blade.php ENDPATH**/ ?>