...
<head>
    ...
    <meta name="description" content="Mobilekit HTML Mobile UI">
...
<body class="bg-white">
    ...
    <div id="appCapsule" class="pt-0">
        <div class="login-form mt-1">
            <div class="section">
                <img src="<?php echo e(asset('assets/img/login/JW.png')); ?>" alt="image" class="form-image">
            </div>
            <div class="section mt-1">
                <h1>Presensi JavaWebster</h1>
...
<?php /**PATH C:\Users\Rezky\OneDrive\Documents\project\september\laravel absen\absen\resources\views/auth/login.blade.php ENDPATH**/ ?>