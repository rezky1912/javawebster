    ...
    <table class="tabelpresensi">
        ...
        <tr>
            ...
            <tr>
                ...
                <td><img src="<?php echo e(url($path_in)); ?>" class="foto" alt=""></td>
                <td><?php echo e($d->jam_out !== null ? $d->jam_out  : 'Belum Absen'); ?></td>
                <td>
                    <?php if($d->jam_out !== null): ?>
                    <img src="<?php echo e(url($path_out)); ?>" class="foto" alt=""></td>
                    <?php else: ?>
                    <img src="<?php echo e(asset ('assets/img/camera.png')); ?>" class="foto" alt=""></td>
                    <?php endif; ?>
                </td>
                <td>
...
</html><?php /**PATH C:\Users\Rezky\OneDrive\Documents\project\september\laravel absen\absen\resources\views/presensi/cetaklaporan.blade.php ENDPATH**/ ?>