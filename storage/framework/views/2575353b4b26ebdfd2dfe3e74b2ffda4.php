                ...
                <form action="/presensi/izinsakit" method="get" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="input-icon mb-3">
                                ...
                                <input type="text" value="<?php echo e(Request('nik')); ?>" id="nik" class="form-control" placeholder="Nik" name="nik">
                            </div>
                        </div>
                        <div class="col-3">
                        <div class="input-icon mb-3">
                                ...
                                <input type="text" value="<?php echo e(Request('nama_lengkap')); ?>" id="nama_lengkap" class="form-control" placeholder="Nama Karyawan" name="nama_lengkap">
                            </div>
                        </div>
                        <div class="col-3">
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                <button class="btn btn-primary" type="submit"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-search" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php if($d->status_approved==0): ?>
                                <a href="#" class="btn btn-sm btn-primary" id="approve" id_izinsakit="<?php echo e($d->id); ?>">
                                ...
                                <?php else: ?>
                                <a href="/presensi/<?php echo e($d->id); ?>/batalkanizinsakit" class="btn btn-sm bg-danger">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.tabler', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Rezky\OneDrive\Documents\project\september\laravel absen\absen\resources\views/presensi/izinsakit.blade.php ENDPATH**/ ?>