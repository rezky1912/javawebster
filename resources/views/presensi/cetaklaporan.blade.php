  ...
  <section class="sheet padding-10mm">
    ...
    <table style="width: 100%;">
        <tr>
            <td>
                <td style="width: 70px;">
                    <img src="{{ asset ('assets\img\JWM.png')}}" width="70" height="70" alt="">
                </td>
                <td>
                    <span id="title">
                    Laporan Absensi Karyawan Periode {{ $namabulan[$bulan]}} {{$tahun}}<br>    
        ...
        <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    @else
                    <img src="{{ asset ('assets/img/camera.png')}}" class="foto" alt=""></td>
                    @endif
                </td>
                <td>
                @if ($d->jam_in > '08:30')
