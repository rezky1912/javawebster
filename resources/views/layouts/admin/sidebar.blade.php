            ...
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="/divisi">Divisi</a>
                    </div>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="/presensi/monitoring">
                    ...
                    <span class="nav-link-title">Monitoring Absensi</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/presensi/izinsakit"> <!-- Tambahkan tombol ini -->
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="/presensi/laporan">Absensi</a>
                        <a class="dropdown-item" href="/presensi/rekap">Rekap Absensi</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link" href="#" data-bs-toggle="dropdown">
